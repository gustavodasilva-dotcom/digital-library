...
namespace Modules.Books.Persistence.Migrations
{
    ...
    [Migration("20240609123012_BooksPublisherIdColumn")]
    partial class BooksPublisherIdColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DigitalLibrary.Modules.Books.Domain.Entities.Publisher", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Publishers", "books");
                });

            modelBuilder.Entity("DigitalLibrary.Modules.Books.Domain.Entities.Book", b =>
                {
                    b.HasOne("DigitalLibrary.Modules.Books.Domain.Entities.Publisher", null)
                        .WithMany("Books")
